...
try {
  ...
  const response = await axios.get(
    "https://globalshippingonline247.onrender.com/api/track/" +
      number +
      "/"
  );
...
return ( <div className="tracking-container"> <div className="tracking-box"> <h2>Track Your Shipment</h2>
      ...
      <div className="tracking-result">
        ...
        <div className="history-header">
          ...
          <span className="history-count">
            {shipment.trackingHistory.length} Updates
          </span>
        </div>
